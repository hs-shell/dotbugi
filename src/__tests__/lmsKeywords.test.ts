...
describe('normalizeLmsRange', () => {
  ...
  it('ko/en range 정규화', () => {
    expect(normalizeLmsRange('2024-03-15 09:00 ~ 2024-03-22 23:59')).toBe('2024-03-15 09:00 ~ 2024-03-22 23:59');
  });

  it('ja range 정규화', () => {
    expect(normalizeLmsRange('2023年 04月 24日(月曜日) 10:50 ~ 2023年 05月 01日(月曜日) 23:59')).toBe(
      '2023-04-24 10:50 ~ 2023-05-01 23:59'
    );
  });

  it('zh range 정규화', () => {
    expect(normalizeLmsRange('2023年04月24日 星期一 10:50 ~ 2023年05月01日 星期一 23:59')).toBe(
      '2023-04-24 10:50 ~ 2023-05-01 23:59'
    );
  });
